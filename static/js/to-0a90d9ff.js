import{d as u,r as s,a as t,o as v,b as f,g as e,w as a}from"./to-f1ccf9a4.js";import{_ as b}from"./to-c27b6911.js";const V={class:"editor"},g=u({name:"demo-editor"}),w=u({...g,setup(y){const _=s("富文本编辑器 cl-editor-wang"),d=s("富文本编辑器 cl-editor-quill"),c=s(`// 代码编辑器 cl-editor-monaco
class User {
    main() {
